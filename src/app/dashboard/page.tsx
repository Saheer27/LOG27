...
export default function Dashboard() {
  ...
  return (
    <div className="w-full">
      <div className="w-full bg-gradient-to-r from-teal-500 to-blue-600 text-white rounded-2xl shadow-lg p-4 sm:p-8 mb-6 text-center">
        <h1 className="text-xl md:text-3xl font-extrabold leading-snug">
